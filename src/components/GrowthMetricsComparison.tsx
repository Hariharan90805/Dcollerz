  ...
  return (
    <section className="py-20 lg:py-28 bg-neutral-900/90 text-white relative overflow-hidden border-t border-b border-neutral-800" id="growth-metrics">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-20">
        ...
        {/* 1. Interactive Local ROI & Revenue Calculator (Estimate Your 30-Day Revenue Upside) */}
        <motion.div 
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: '-60px' }}
          transition={{ duration: 0.6 }}
          className="p-6 sm:p-8 rounded-3xl bg-neutral-950 border border-amber-500/30 flex flex-col justify-between space-y-6 shadow-xl max-w-4xl mx-auto"
        >
          <div className="space-y-2 text-center">
            <div className="inline-flex items-center gap-2 text-xs font-bold text-amber-400 uppercase tracking-wider justify-center">
          ...
          <div className="space-y-3 bg-neutral-900/80 p-6 rounded-xl border border-neutral-800 max-w-2xl mx-auto w-full">
          ...
          {/* Forecast Output Box */}
          <div className="p-6 rounded-2xl bg-gradient-to-br from-neutral-900 to-black border border-amber-400/40 space-y-6 max-w-3xl mx-auto w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-center">
              <div className="p-4 bg-neutral-900/90 rounded-xl border border-neutral-800">
                <span className="text-xs text-neutral-400 block uppercase mb-1">Est. Monthly Leads</span>
                <span className="text-3xl font-extrabold text-white font-mono">
                  {currentCalc.monthlyLeads}+ Leads
                </span>
              </div>
              <div className="p-4 bg-neutral-900/90 rounded-xl border border-neutral-800">
                <span className="text-xs text-neutral-400 block uppercase mb-1">Est. Closures (30d)</span>
            ...
            <div className="pt-4 border-t border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
              <div>
                <span className="text-sm text-neutral-400 block mb-1">Projected New Monthly Pipeline:</span>
                <span className="text-3xl sm:text-4xl font-black text-amber-300 font-mono">
                  ₹{estimatedNewRevenue.toLocaleString('en-IN')}
                </span>
              </div>
              <span className="text-sm font-bold text-emerald-400 bg-emerald-950/80 px-4 py-2 rounded-lg border border-emerald-500/40">
                ~4.5x Average ROI
              </span>
            </div>
          </div>
        ...
        {/* 2. Grow Your Business in Krishnagiri & Regional Hubs (Header + Chart) */}
        <div>
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.div 
            ...
            className="bg-neutral-950/80 border border-neutral-800 rounded-3xl p-6 sm:p-8 shadow-2xl"
          >
        ...
        {/* 3. Slide 08 • Market Reach Opportunity (Population Funnel) */}
        <motion.div 
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: '-60px' }}
          transition={{ duration: 0.6 }}
          className="p-6 sm:p-10 rounded-3xl bg-neutral-950 border border-neutral-800 flex flex-col justify-between space-y-8 shadow-xl max-w-5xl mx-auto"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-neutral-900 border border-neutral-800 space-y-2 text-center">
              <span className="text-xs font-bold text-neutral-400 uppercase tracking-widest">Total Population</span>
              <p className="text-4xl font-black text-white font-mono">~2.45M</p>
              <p className="text-xs text-neutral-400">District & economic corridor</p>
            </div>

            <div className="p-6 rounded-2xl bg-neutral-900 border border-cyan-500/30 space-y-2 text-center">
              <span className="text-xs font-bold text-cyan-400 uppercase tracking-widest">Target 10% Market</span>
              <p className="text-4xl font-black text-cyan-300 font-mono">~245,000</p>
              <p className="text-xs text-neutral-400">Active online seekers</p>
            </div>

            <div className="p-6 rounded-2xl bg-neutral-900 border border-emerald-500/40 space-y-2 text-center transform scale-105 shadow-2xl shadow-emerald-500/10">
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-widest">Qualified Leads</span>
              <p className="text-4xl font-black text-emerald-400 font-mono">~24,500+</p>
              <p className="text-xs text-emerald-300 font-semibold">Good Leads = More Profit $</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-emerald-950/40 border border-emerald-500/30 space-y-4">
            <h4 className="text-sm font-extrabold uppercase tracking-wider text-emerald-300 text-center">
              What You Get With DCOLLABERZ:
            </h4>
            <ul className="space-y-3 text-sm text-neutral-300 max-w-3xl mx-auto">
